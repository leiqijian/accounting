...
@Aspect
public class QueryDictAllValueAspect {
    ...
    @Around("execution(* com.liquido.base.api.DictionaryApi.queryDictAllValue"
            + "(com.liquido.base.enums.DictionaryTypeEnum, Class, String...))")
