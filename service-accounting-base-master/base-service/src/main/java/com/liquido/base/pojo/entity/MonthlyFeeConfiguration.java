...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "monthly_fee_configuration")
@Where(clause = "del_flag = false")
public class MonthlyFeeConfiguration implements Serializable {
    ...
    /**
     * Identify the gradient of execution
     */
    @Column(name = "account_fee_configuration_id")
