...
@Slf4j
public class RefundControllerTest extends AbstractTest {

    /**
     * test accountTopUp
     */
    @Rollback(false)
    @Test(description = "accountRefund", dataProvider = "refundProvider",
            dataProviderClass = DataParameter.class)
    public void accountTopUp(TestNgParams<TransactionBizVo> params) throws Exception {
        final String api = "/statement/account/refund";
