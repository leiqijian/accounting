...
>
    ...
    >
        ...
        <div style="margin-bottom: 30px">Dear ${merchantName} team ,</div>
        <div style="margin-bottom: 30px">
            We are sorry to inform you that your <span style="color: rgb(255, 0, 0)" >${accountInfo}</span> account balance is below the threshold you have set of $${amountLimit} ${currency}, your current account balance is $${currentAmount} ${currency}. To ensure that your business is not affected, we suggest that you recharge as soon as possible.
        </div>
        <div style="margin-bottom: 30px">
            Click the link below to check out your balance:
        </div>
        <div style="margin-bottom: 60px">
            <a
                    style="color: rgb(51, 112, 255)"
                    href="https://merchant-v2.liquido.com/"
            >https://merchant-v2.liquido.com/</a
            >
        </div>
    ...
    <div style="padding: 20px; margin-top: 5px; text-align: center">
        ...
        >
            ...
            <div>
                Feel free to contact <a style="color: rgb(51, 112, 255)" href="payoutfunding@liquido.com">payoutfunding@liquido.com</a> if you have any questions.
            </div>
        </div>
    </div>
    <!-- </div> -->
