...
@Component
public class TimerLarkMonitorPublisher
        extends SqsMessagePublisher<TimerLarkMonitorMsg> {

    @Autowired
    public TimerLarkMonitorPublisher(
    ...
    private static String getQueryUrl(
        ...
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.TIMER_LARK_MONITOR).getUrl();
    }
