...
import com.liquido.statement.aws.sqs.consum.TimerLarkMonitorConsumer;
...
public class TimerLarkMonitorConsumerRegister
        extends BaseConsumerRegister<TimerLarkMonitorMsg> {

    @Autowired
    public TimerLarkMonitorConsumerRegister(
            final TimerLarkMonitorConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_LARK_MONITOR));
    }
