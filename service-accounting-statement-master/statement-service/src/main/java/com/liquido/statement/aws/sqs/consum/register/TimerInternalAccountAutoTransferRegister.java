...
import com.liquido.statement.aws.sqs.consum.TimerInternalAccountAutoTransferConsumer;
...
public class TimerInternalAccountAutoTransferRegister
        extends BaseConsumerRegister<TimerInternalAccountAutoTransferMsg> {

    @Autowired
    public TimerInternalAccountAutoTransferRegister(
            final TimerInternalAccountAutoTransferConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_INTERNAL_ACCOUNT_AUTO_TRANSFER));
    }
}
