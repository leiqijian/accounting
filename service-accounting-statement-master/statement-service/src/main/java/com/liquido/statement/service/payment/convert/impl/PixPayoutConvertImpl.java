...
/**
 * Country: Brazil
 * PIX Payment Payout Response Data Converter
 */
@Component
public class PixPayoutConvertImpl implements PayoutResultConvert<PixPayoutResult> {

    @Override
    public ProductCodeEnum getProductCode() {
        return ProductCodeEnum.PIX;
    }

    @Override
    public QueryPayoutResultDto convertResult(final PixPayoutResult dto) {
