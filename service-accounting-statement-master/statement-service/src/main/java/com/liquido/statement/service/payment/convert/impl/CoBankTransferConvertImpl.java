 ...
 */
@Component
public class CoBankTransferConvertImpl implements PayoutResultConvert<CoBankTransferPayoutResult> {
    ...
    @Override
    public QueryPayoutResultDto convertResult(final CoBankTransferPayoutResult dto) {
