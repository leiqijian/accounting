...
// !!!!! if this class add flied , need to BatchOperatorRepository batchInsertSubAccountStatement method update sql
@Getter
@Setter
@Entity
@Builder
...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "sub_account_statement")
@Where(clause = "del_flag = false")
@EntityListeners({AuditingEntityListener.class})
@SuppressWarnings("PMD.TooManyFields")
public class SubAccountStatement implements Serializable {
