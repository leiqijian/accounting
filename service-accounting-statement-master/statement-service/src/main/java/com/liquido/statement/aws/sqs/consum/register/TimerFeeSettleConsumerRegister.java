...
import com.liquido.statement.aws.sqs.consum.TimerFeeSettleConsumer;
...
public class TimerFeeSettleConsumerRegister extends BaseConsumerRegister<TimerFeeSettleMsg> {

    @Autowired
    public TimerFeeSettleConsumerRegister(
            final TimerFeeSettleConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_FEE_SETTLE));
    }
