...
@Component
public class TimerInternalAccountAutoTransferPublisher
        extends SqsMessagePublisher<TimerInternalAccountAutoTransferMsg> {

    @Autowired
    public TimerInternalAccountAutoTransferPublisher(
    ...
    private static String getQueryUrl(
        ...
        return properties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_INTERNAL_ACCOUNT_AUTO_TRANSFER).getUrl();
    }
}
