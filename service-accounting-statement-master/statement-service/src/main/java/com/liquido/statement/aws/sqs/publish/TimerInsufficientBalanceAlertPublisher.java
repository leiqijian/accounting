...
@Component
public class TimerInsufficientBalanceAlertPublisher
        extends SqsMessagePublisher<TimerInsufficientBalanceAlertMsg> {

    @Autowired
    public TimerInsufficientBalanceAlertPublisher(
    ...
    private static String getQueryUrl(
        ...
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.TIMER_INSUFFICIENT_BALANCE_ALERT)
                .getUrl();
    }
