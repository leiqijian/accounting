...
public class ClBankTransferPayoutResult implements BasePayoutResult {
    ...
    /**
     * @deprecated The transfer amount. note: 1=1CLP
     * use: amountInCents
     */
    @Deprecated
    ...
    /**
     * The transfer amount. note: 100=1CLP
     */
    private BigDecimal amountInCents;

    /**
     * The currency code of the transferred fund. enum value as CLP
     */
    ...
    /**
     * Target account holder identity, RUT
     */
