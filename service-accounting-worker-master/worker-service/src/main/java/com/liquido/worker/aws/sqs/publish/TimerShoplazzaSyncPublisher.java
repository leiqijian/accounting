...
@Component
public class TimerShoplazzaSyncPublisher extends SqsMessagePublisher<TimerShoplazzaSyncMsg> {

    @Autowired
    public TimerShoplazzaSyncPublisher(final AwsSqsProperties.SqsQueueInfoProperties properties,
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.TIMER_SHOPLAZZA_SYNC).getUrl();
    }
