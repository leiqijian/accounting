...
@Component
public class TimerTransactionMetricPublisher
        extends SqsMessagePublisher<TimerTransactionMetricMsg> {

    @Autowired
    public TimerTransactionMetricPublisher(final AwsSqsProperties.SqsQueueInfoProperties properties,
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.TIMER_TRANSACTION_METRIC)
                .getUrl();
    }
