...
@Component
public class TimerPaymentLinkSyncPublisher extends SqsMessagePublisher<TimerPaymentLinkSyncMsg> {

    @Autowired
    public TimerPaymentLinkSyncPublisher(final AwsSqsProperties.SqsQueueInfoProperties properties,
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.TIMER_PAYMENT_LINK_SYNC).getUrl();
    }
