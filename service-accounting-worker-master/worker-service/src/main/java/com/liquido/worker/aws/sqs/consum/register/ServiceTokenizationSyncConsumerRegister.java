...
import com.liquido.worker.aws.sqs.consum.ServiceTokenizationSyncConsumer;
...
public class ServiceTokenizationSyncConsumerRegister extends
        BaseConsumerRegister<ServiceCardTokenizationSyncMsg> {

    @Autowired
    public ServiceTokenizationSyncConsumerRegister(
            final ServiceTokenizationSyncConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.SERVICE_TOKENIZATION_SYNC));
    }
