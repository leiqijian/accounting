...
@Component
public class ServiceShopifySyncPublisher extends
        SqsMessagePublisher<ServiceShopifySyncMsg> {

    @Autowired
    public ServiceShopifySyncPublisher(
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.SERVICE_SHOPIFY_SYNC)
                .getUrl();
    }
