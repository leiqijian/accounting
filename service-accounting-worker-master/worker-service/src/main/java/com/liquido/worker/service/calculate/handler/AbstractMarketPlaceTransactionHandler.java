...
/**
 * Abstract MarketPlace TransactionHandler
 */
@Slf4j
@Service
@RequiredArgsConstructor
public abstract class AbstractMarketPlaceTransactionHandler implements TransactionStrategy {
    @Resource
    ...
    public void batchProcessCalculate(
        ...
        watch.start("MarketPlace batch calculation fee");
        ...
        watch.start("MarketPlace batch process settlement");
    ...
    protected PreCalculateConfigBo preProcessCalculate(final TaskFeeCalculation taskOrder) {
        log.info("MarketPlace task preCalculate begin. taskOrder={}", taskOrder);
        ...
        log.info("MarketPlace task preCalculate end. ts={}ms, taskOrderId={}",
    ...
    protected TransactionMoneyBo processingCalculate(
        ...
        /* STEP5: Deal calculate transaction extra fee*/
        transactionMoney.setTransactionExtraFeeList(
                transactionExtraIncomeService.calculateExtraIncome(
                        transactionMoney, usdDailyRateInfo, preConfig.getExtraIncomeConfig()));
