...
import com.liquido.worker.aws.sqs.consum.TimerShopifySyncConsumer;
...
public class TimerShopifySyncConsumerRegister extends
        BaseConsumerRegister<TimerShopifySyncMsg> {

    @Autowired
    public TimerShopifySyncConsumerRegister(
            final TimerShopifySyncConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_SHOPIFY_SYNC));
    }
