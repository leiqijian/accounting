...
import com.liquido.worker.aws.sqs.consum.TimerTokenizationSyncConsumer;
...
public class TimerTokenizationSyncConsumerRegister extends
        BaseConsumerRegister<TimerTokenizationSyncMsg> {

    @Autowired
    public TimerTokenizationSyncConsumerRegister(
            final TimerTokenizationSyncConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_TOKENIZATION_SYNC));
    }
