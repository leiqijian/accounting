...
import com.liquido.worker.aws.sqs.consum.ServiceShoplazzaSyncConsumer;
...
public class ServiceShoplazzaSyncConsumerRegister extends
        BaseConsumerRegister<ServiceShoplazzaSyncMsg> {

    @Autowired
    public ServiceShoplazzaSyncConsumerRegister(
            final ServiceShoplazzaSyncConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.SERVICE_SHOPLAZZA_SYNC));
    }
