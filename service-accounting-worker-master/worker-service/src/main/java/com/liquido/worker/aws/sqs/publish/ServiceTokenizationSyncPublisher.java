...
@Component
public class ServiceTokenizationSyncPublisher extends
        SqsMessagePublisher<ServiceCardTokenizationSyncMsg> {

    @Autowired
    public ServiceTokenizationSyncPublisher(
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.SERVICE_TOKENIZATION_SYNC)
                .getUrl();
    }
