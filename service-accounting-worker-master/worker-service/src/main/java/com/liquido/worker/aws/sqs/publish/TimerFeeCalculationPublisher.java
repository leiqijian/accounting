...
@Component
public class TimerFeeCalculationPublisher extends SqsMessagePublisher<TimerFeeCalculationMsg> {

    @Autowired
    public TimerFeeCalculationPublisher(final AwsSqsProperties.SqsQueueInfoProperties properties,
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.TIMER_FEE_CALCULATION).getUrl();
    }
