...
import com.liquido.worker.aws.sqs.consum.TimerPaymentLinkSyncConsumer;
...
public class TimerPaymentLinkSyncConsumerRegister extends
        BaseConsumerRegister<TimerPaymentLinkSyncMsg> {

    @Autowired
    public TimerPaymentLinkSyncConsumerRegister(
            final TimerPaymentLinkSyncConsumer consumer,
        ...
        super(consumer, client, objectMapper, infoProperties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.TIMER_PAYMENT_LINK_SYNC));
    }
}
