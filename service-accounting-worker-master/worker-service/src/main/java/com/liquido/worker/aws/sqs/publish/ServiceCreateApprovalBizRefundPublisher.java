...
@Component
public class ServiceCreateApprovalBizRefundPublisher extends
        SqsMessagePublisher<ServiceCreateApprovalBizRefundMsg> {

    @Autowired
    public ServiceCreateApprovalBizRefundPublisher(
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues()
                .get(Constant.AWS_QUEUE_KEYS.SERVICE_CREATE_APPROVAL_BIZ_REFUND_KEY)
                .getUrl();
    }
