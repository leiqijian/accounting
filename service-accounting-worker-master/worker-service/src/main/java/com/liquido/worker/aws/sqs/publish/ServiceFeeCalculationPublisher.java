...
@Component
public class ServiceFeeCalculationPublisher extends SqsMessagePublisher<ServiceFeeCalculationMsg> {

    @Autowired
    public ServiceFeeCalculationPublisher(final AwsSqsProperties.SqsQueueInfoProperties properties,
    ...
    private static String getQueryUrl(final AwsSqsProperties.SqsQueueInfoProperties properties) {
        return properties.getQueues().get(Constant.AWS_QUEUE_KEYS.SERVICE_FEE_CALCULATION)
                .getUrl();
    }
